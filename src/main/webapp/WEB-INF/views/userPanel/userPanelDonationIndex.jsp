        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary"> <!-- Topbar Search -->
                        <form
                    ...
                    <table>
                        ...
                        <c:forEach items="${donations}" var="donation">
                            <tr>
                                ...
                                <td>
                                    <form action="/userPanel/donations/${donation.id}" style="display: inline;">
                                        <button type="submit" class="edit-button">View</button>
                                    </form>
                                    <form action="/userPanel/donations/edit/${donation.id}" style="display: inline;">
                                        <button type="submit" class="edit-button">Edit</button>
                                    </form>
                                    <form action="/userPanel/donations/delete/${donation.id}" style="display: inline;">
